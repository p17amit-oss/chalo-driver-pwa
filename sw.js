...
self.addEventListener('push',e=>{let d={title:'Chalo Driver',body:'You have a new duty update.'};try{d={...d,...e.data.json()}}catch{}e.waitUntil(self.registration.showNotification(d.title,{body:d.body,icon:'icon-192.png',badge:'icon-192.png',data:d.url||'./'}))});
